...
//	}
	...
	private static String readAll(Reader rd) throws IOException {
		  ...
		  public static void getAddressFromGoogle(String address){
				JsonNode result = restTemplate.getForObject("https://maps.googleapis.com/maps/api/geocode/json?language=iw&address={address}&key={myKey}", JsonNode.class, address, "AIzaSyCuN-gakCi1sQnCimos09VP1sLyHw9zcFc");

				restTemplate.getForObject("https://maps.googleapis.com/maps/api/geocode/json?address={address}&key={myKey}", JsonNode.class, "קרית מוצקין  שרת 1", "AIzaSyCuN-gakCi1sQnCimos09VP1sLyHw9zcFc");
				
//				restTemplate.getForObject("https://maps.googleapis.com/maps/api/geocode/json?language=iw&address={address}&key={myKey}", JsonNode.class, "קרית מוצקין  שרת 1", "AIzaSyCuN-gakCi1sQnCimos09VP1sLyHw9zcFc");
...
//			  System.out.println(getAltLong());
			  getAddressFromGoogle("אריאל שרון 1 אור יהודה");
		  }
